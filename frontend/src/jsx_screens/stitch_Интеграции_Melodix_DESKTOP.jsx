...
<div className="px-6 mb-8 flex items-center gap-4">
    ...
    <div className="flex items-center">
        <h1 className="font-display-lg-mobile text-display-lg-mobile font-black text-primary dark:text-primary leading-none transition-all duration-300 hover:text-[#b066ef] hover:drop-shadow-[0_0_8px_rgba(157,78,221,0.6)]">Kudex</h1>
...
{/*  Main Content Canvas  */}
<main className="md:ml-[280px] pt-24 pb-[120px] h-full overflow-y-auto px-margin-page bg-pattern relative">
...
<section className="bg-surface-container-low border border-white/5 rounded-xl p-8 shadow-[0_8px_30px_rgba(0,0,0,0.5)]">
