...
<div className="px-gutter mb-section-gap flex-col"><div className="flex items-center gap-3">
    <img src="https://lh3.googleusercontent.com/aida/ADBb0uin_iXZTnSWGq3sYdyHBfo045EN961zjT-77UvFA8pGxfgkKgdLL57Rr2LLWBXDmOhu9OacJRlBgQ3RjA1egZBOUPGNHZknwyAf4ZrLDiiuFaYlUMTFUm2EXdlp1n27YXouNv_C4lmYNLHwS-0bLK_7jNoH1lNPxq7xCQ8CoXtrmgxqEQo3ucf0WMmlE-PtZYpvtHe0fQtKvZPZ8XX76imrbLesUUFK2xa8adCmEfIz6p5mfTrpZORfPXc" alt="Kudex Logo" className="h-10 w-10 object-contain" />
    <h1 className="font-display-lg text-[24px] font-black text-primary transition-colors duration-300 hover:text-primary-fixed">Kudex</h1>
</div></div>
...
<h1 className="font-display-lg-mobile text-display-lg-mobile font-black text-primary">Kudex</h1>
<div className="flex items-center gap-4 text-primary dark:text-primary">
...
<main className="md:ml-sidebar-width pt-20 md:pt-24 pb-32 px-gutter h-screen overflow-y-auto bg-[#121214]">
